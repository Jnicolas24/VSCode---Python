'''
numero = 1
limite = int(input("Digite até qual número você quer contar: "))

while numero <= limite: #enquanto o numero for menor ou igual que 5
    print (numero) #exibe o numero

    #o simbolo += serve para fazer uma soma com atribuição
...
# #startswith (stringBuscada) - faz uma busca no início da palavra
# print(nome.startswith('a')) #buscam palavras que iniciam com 'a'
